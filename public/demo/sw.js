...
const STATIC_ASSETS = [
    ...
    'js/pages/attendance.js?v=5',
    'js/pages/sales.js?v=5',
    'js/pages/workflows.js?v=5',
    'js/pages/problems.js?v=5',
    'js/pages/branches.js?v=5',
    'js/pages/communications.js?v=5',
    'js/pages/hr.js?v=5',
    'js/pages/import.js?v=5',
    'js/pages/ai.js?v=5',
    'js/pages/products.js?v=5',
    'js/pages/users.js?v=5',
    'js/pages/settings.js?v=5',
    'manifest.json',
];
